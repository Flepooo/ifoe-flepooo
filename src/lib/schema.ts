...
export const ContactSchema = z.object({
  first_name: z.string().nonempty({ message: "لا يمكن اهمال هذا المدخل" }),
  last_name: z.string().nonempty({ message: "لا يمكن اهمال هذا المدخل" }),
  email: z
    .string()
    .nonempty({ message: "لا يمكن اهمال هذا المدخل" })
    .email({ message: "البريد الالكتروني غير صحيح" }),
...
export const ExibitionFormSchema = z.object({
  name: z.string().min(2, {
