...
export const CreateBlogForm = () => {
  ...
  const updateMutation = useMutation({
    mutationFn: ({ data, file, blogContent, keywords }: TMutation) => createBlogAction(data, file, blogContent, keywords),
    onSuccess: (data) =>
      showResponse(data, () => {
  ...
  return (
    <div className='grid xl:grid-cols-5 gap-4' dir='ltr'>
      ...
      <div className='xl:col-span-2'>
        ...
        <Image className='w-full h-auto rounded-xl' src={filePreview} alt='Image' width={1000} height={1000} />
      </div>
    </div>
  )
}
